  ...
  return knex('visits').del()
    .then(function () {
      return Promise.all([
        ...
        knex('visits').insert({ customers_id: 2, visit_type: 'Estimate', start: 1481828400000, end: 1483644600000, team_id: 3 }),
        ...
        knex('visits').insert({ customers_id: 5, visit_type: 'Start work', start: 1484163000000, end: 1484249400000, team_id: 1 }),
        ...
        knex('visits').insert({ customers_id: 2, visit_type: 'Estimate', start: 1484593200000, end: 1486407600000, team_id: 3 }),
