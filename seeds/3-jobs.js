  ...
  return knex('jobs').del()
    .then(function () {
      return Promise.all([
        ...
        knex('jobs').insert({customer_name: 'Vina Pho & Grill', phone_number: '1234567890', address: '1630 30th St', city: 'Boulder', state: 'CO', zip: 80303, job_type: 'Red', team_id: 2, lat: 40.0152767, lng: -105.2532192}),
